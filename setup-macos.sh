...
install() {
  if [[ ${OSTYPE} =~ ^darwin ]]; then
    ...
    sudo systemsetup -setcomputername pegasus
    ...
    sudo scutil --set ComputerName pegasus
    sudo scutil --set HostName pegasus
    sudo scutil --set LocalHostName pegasus
    sudo networksetup -setcomputername pegasus
